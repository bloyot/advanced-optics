...
* [`src/web/styles.cljs`](src/web/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/web/`](src/web/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/web/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `web` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/web/config.cljs) defaults to `true` in
